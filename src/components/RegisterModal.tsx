...
export default function RegisterModal({
  ...
  return (
    <dialog
      ref={dialogRef}
      className="w-full max-w-lg rounded-2xl border border-neutral-700 bg-neutral-900 p-0 text-brand-white backdrop:bg-brand-black/80"
      aria-modal="true"
    ...
    >
      <div className="p-6">
        <div className="flex items-start justify-between">
          ...
          <button
            onClick={handleClose}
            className="rounded-lg p-1 text-brand-white/50 hover:text-brand-white"
            aria-label="Close"
          >
