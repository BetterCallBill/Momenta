...
> Sorted by priority (High → Medium → Low), then phase. Last updated: 2026-05-13.
...
1. **Task 13** — Calendar monthly grid: highlight dates with events
3. **Task 14** — Events page two-column layout (calendar left, detail panel right)
4. **Task 15** — Event detail page: full-width poster banner (`posterImage` field)
